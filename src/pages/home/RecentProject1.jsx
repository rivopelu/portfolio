        ...
        <>
            ...
            <div className='pt-5'>
                ...
                <div className="row  w-full pt-10  mb-7">
                    ...
                    <p className='lg:text-2xl'>this is a static website built with react-js, tailwindCss, I'm trying to make a web design from a ui designed by viktor Ewing as a UI/UX designer</p>
                </div>

                <img src={CoverHomePng} className='lg:w-[70%] rounded-2xl outline outline-4 outline-gray-500 lg:mt-16 lg:mx-auto' alt="rivo booking app" />
                <GarisComp className='mt-4' />
                <div className="row  w-full pt-10  mb-7">
                    <dir className='flex  items-center mb-5 w-full justify-between'>
                    ...
                    <p className='lg:text-2xl'>this is a chat application built with reactJs technology and tailwindCss as a CSS framework. the design of this application I tried to take a reference from the ui/ux design made by indra yoga.</p>
                </div>

                <img src={chatAppImg} className='lg:w-[70%] rounded-2xl outline outline-4 outline-gray-500 lg:mt-16 lg:mx-auto' alt="rivo booking app" />
