...
import cv from '../../pages/home/img/cv.pdf';
const AboutSection = () => {
    const downloadCv = () => {

        saveAs(cv, 'Rivo Pelu CV')
    }
    return (
        <div id="aboutSection">
